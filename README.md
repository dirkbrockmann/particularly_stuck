...
If you just want to run the explorable you can [**Click here.**](https://raw.githack.com/dirkbrockmann/particularly_stuck/main/dist/index.html)
...
<html>
	<head>
		...
		<script src="https://cdn.jsdelivr.net/npm/@explorables/particularly_stuck/dist/index.umd.js"></script>
		...
	</head>
		...
	<body>
...
<html>
	<head>
		...
	    <script type="module">
	  	      import load from 'https://cdn.jsdelivr.net/npm/@explorables/particularly_stuck/dist/index.es.js';
	  	      const particularly_stuck = load("explorable_container");
	    </script>
	    <script nomodule src="https://cdn.jsdelivr.net/npm/@explorables/particularly_stuck/dist/index.umd.js"></script>	  
		...
	</head>
		...
	<body>
